...
class MMMMTokenizer(LlamaTokenizer):
    def __init__(self, *args, **kwargs):
        ...
        self.seg_token = '<SEG>'
        self.add_tokens(
            [self.bop_token, self.eop_token, self.usr_token, self.sys_token, self.seg_token],
            True,
        )
        self.bop_token_id, self.eop_token_id, self.usr_token_id, self.sys_token_id, self.seg_token_id = (
