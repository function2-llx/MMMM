...
prompt_highlight = """
You are an AI assistant specialized in radiology. Your task is to carefully analyze the provided radiology report and highlight key anatomical structures mentioned in the report by enclosing them with "<p>" and "</p>" tags.
The anatomical structures include organs, organ components and anatomical abnormalities, such as "heart", "left lung", "stomach", "duodenum", "spleen", "pancreas", "white matter", "cardiac silhouette", "mediastinum", "left lower lung zone", "left hilar structures", "upper mediastinum", "aortic arch", "right hemidiaphragm", "right clavicle", "trachea", "left apical zone", "carina", "right atrium", "cavoatrial junction", "abdomen", "spine", "atelectasis", "cardiomegaly", "consolidation", "edema", "enlarged cardiomediastinum", "fracture", "lesion", "mass", "opacity", "pleural effusion", "pleural thickening", "nodule", "calcification", "aortic enlargement", "pulmonary fibrosis", "mediastinal shift", "ILD", "tumour", "lymph node". You should not highlight any other entities, such as symptoms, diseases, body systems or treatments.
Below are requirements:
1. Be cautious and conservative when highlighting the targets. It is totally fine to miss a few targets but it is unacceptable to highlight any targets that do not meet the requirements.
...
3. Avoid highlighting any targets explicitly stated as absent, negated, or otherwise indicated as not present or uncertain in the findings. E.g., in the context of "no tumor is visible" and "lesion is not observed", the "tumor" and "lesion" should not be highlighted.
4. Do not highlight targets that are too coarse, ambiguous, or amorphous to be spatially localized. E.g., you should not highlight "free fluid", "chest".
...
7. The output should be exactly the original text with additional tags, do not output any additional information. Even if no target is present in the text, the output should be the same as the input.
